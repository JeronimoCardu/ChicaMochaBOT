...
import { MapPin, Phone, Clock, CreditCard, Banknote, Home, Truck, ChevronRight, GripVertical } from "lucide-react";
...
export function OrderCard({ order, isNew, isUpdated, isDragging, onAction }: Props) {
